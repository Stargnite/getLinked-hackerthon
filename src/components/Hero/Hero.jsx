        ...
        <div className="hero_wrapper flex justify-around">
          <div className="hero_content">
            <h1 className="text-6xl font-bold tracking-tight">
              <span className="whitespace-nowrap">getLinked Tech</span> <br />{" "}
              Hackerthon<span className="version">1.0</span>
            </h1>
            <p className="mb-4">
              Participate in getLinkedtech Hackerthon 2023 and stand a chance to
              win a Big prize
            </p>
            <Link to="/register">
